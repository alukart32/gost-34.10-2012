...
namespace DigitalSignECC
{
    public partial class Form1 : Form
    {
        ...
        private void SignButton_Click(object sender, EventArgs e)
        {
            ...
            // Генерация ключей
            d = DS.GenereatePrivateKey(192);
            Q = DS.GeneratePublicKey(d);

            // Шаг 1: вычисление хэш-суммы Msg
            HashFuncStrebog hash = new HashFuncStrebog(256);
            byte[] H = hash.GetHash(Encoding.Default.GetBytes(textBox1.Text));

            // подпись Msg
            string sign  = DS.SingMsg(H, d);
        ...
        private void VerifyButton_Click(object sender, EventArgs e)
        {
            ...
            DigitalSign DS = new DigitalSign(p, a, b, n, xG);
            HashFuncStrebog hash = new HashFuncStrebog(256);
